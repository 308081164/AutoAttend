    ...
    <div v-else>
      <div class="layout">
        <div class="left">
            ...
            <div class="section-body">
              ...
              <template v-if="mode === 'penpot'">
                ...
                <textarea
                  ...
                  class="prompt-textarea"
                  placeholder="描述页面目标、模块、关键文案等；可与左侧 HTML+CSS 对话使用相同需求文本。"
                ></textarea>
          ...
          <div v-if="mode === 'penpot'" class="section-card">
        ...
        <div class="main">
          <div class="section-card">
            <div class="section-head">
              <div class="section-title">
                {{ mode === 'penpot' ? 'Penpot（外链打开）' : 'Mockup 预览（HTML+CSS）' }}
              </div>
      ...
      try {
        ...
        if (resp.data && resp.data.code === 0 && resp.data.data && resp.data.data.requirementText) {
          ...
          if (this.mode === 'mockup') {
            ...
            this.penpotPrompt = t
            this.importHint = '《页面设计文档》已写入 Penpot 需求框（用户叙述为主、报价清单在附录），可补充后生成'
          }
        } else {
