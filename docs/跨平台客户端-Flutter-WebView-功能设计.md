...
| 2026-04-21 | v0.2 | 实现：`client/flutter_shell` 壳工程；`GET /api/public/client/version-check|downloads`；`ClientShellEnforcementFilter`；监测台「壳客户端」配置；官网下载区；GitHub Actions CI/Release。 |

---

*本文档描述产品设计；工程路径以仓库内 `client/flutter_shell` 与 `.github/workflows/flutter-shell-*.yml` 为准。*
